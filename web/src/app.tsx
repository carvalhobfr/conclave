...
type WorkspaceTab = "verdict" | "evidence" | "graph" | "retrieval" | "task" | "settings";
...
export function App() {
  ...
  const activeNav = tab === "settings" ? "settings" : tab === "graph" ? "graph" : intent;
